<%@ Page language="c#" Codebehind="ConfirmCheque.aspx.cs" AutoEventWireup="false" Inherits="confirm_cheque.WebForm1" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" bgColor="#ccffcc" text="#0033ff" bgProperties="fixed">
		<FORM id="Form3" method="post" runat="server">
			<asp:Label id="Label1" style="Z-INDEX: 102; LEFT: 24px; POSITION: absolute; TOP: 128px" runat="server"
			...
			<asp:Label id="Label3" style="Z-INDEX: 108; LEFT: 24px; POSITION: absolute; TOP: 176px" runat="server"
			...
			<asp:Label id="Label2" style="Z-INDEX: 104; LEFT: 24px; POSITION: absolute; TOP: 216px" runat="server"
				Font-Italic="True" Font-Bold="True" Width="144px">Your Choices were :</asp:Label>
			<asp:DataGrid id="MainGrid" style="Z-INDEX: 103; LEFT: 16px; POSITION: absolute; TOP: 248px" runat="server"
			...
			<asp:Button id="Button2" style="Z-INDEX: 101; LEFT: 424px; POSITION: absolute; TOP: 512px" runat="server"
