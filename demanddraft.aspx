<%@ Page CodeBehind="demanddraft.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="proceed1.WebForm1" %>
...
<HTML>
	...
	<BODY bgcolor="#ccffcc">
		<p align="center"><IMG id="IMG5" height="100" src="file:///C:\Inetpub\wwwroot\Erls\design_denno_dreamweaver.JPG"
				width="957" runat="server"></p>
		<TABLE cellSpacing="1" cellPadding="6" width="962" align="center" border="0" height="778">
			<TBODY>
				<TR bgColor="#ffffff">
				...
				<TR bgColor="#ffffff">
					...
					<TD height="53" bgcolor="#ff0000" class="style24"><INPUT name="t10" class="fnt" id="t10" style="BORDER-RIGHT: #eb8500 1px solid; BORDER-TOP: #eb8500 1px solid; BORDER-LEFT: #eb8500 1px solid; BORDER-BOTTOM: #eb8500 1px solid"
							size="25" maxLength="56" runat="server"> &nbsp;&nbsp;</TD>
				</TR>
				<TR bgColor="#ffffff">
