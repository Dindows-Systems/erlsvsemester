...
namespace paymentdetails
{
	...
	public class WebForm1 : System.Web.UI.Page
	{
		...
		private void Button5_Click(object sender, System.EventArgs e)
		{
			...
			SqlCommand InsertCmd = new SqlCommand("DELETE from booksonline WHERE username ='" + username + "' AND sysdate = {"+ d + "}",con);
			InsertCmd.ExecuteNonQuery();	
			SqlCommand delCmd = new SqlCommand("DELETE from visitors WHERE username ='" + username +"' AND sysdate = {" + d + "}",con);
		...
		{
			Response.Redirect("facility-error.html");
		}
