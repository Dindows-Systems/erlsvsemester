...
namespace cheque
{
	...
	public class WebForm1 : System.Web.UI.Page
	{
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			con.Open();
			SqlCommand CreateTableCmd = new SqlCommand("Insert into cheque VALUES("+ t11.Value.ToString()+ "," + TEXTAREA1.Value.ToString() + "," + Text1.Value.ToString() + "," + Text2.Value.ToString() + "," + t5.Value.ToString()+ "," + t6.Value.ToString()+ "," +t7.Value.ToString()+ "," +t8.Value.ToString()+ "," + t9.Value.ToString()+ "," + Convert.ToString(money) + ")",con);
			CreateTableCmd.ExecuteNonQuery();	
			con.Close();

			Response.Redirect("ConfirmCheque.aspx");
		}
